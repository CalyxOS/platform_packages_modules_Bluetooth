    ...
    private final OnAlarmListener mBluetoothTimeoutListener = new OnAlarmListener() {
        ...
        public void onAlarm() {
            try {
                ...
                int adapterConnectionState = BluetoothAdapter.STATE_DISCONNECTED;
                try {
                    adapterConnectionState = recv.awaitResultNoInterrupt(getSyncTimeout())
                        .getValue(adapterConnectionState);
                } catch (TimeoutException e) {
                    Slog.w(TAG, "setBluetoothTimeout() timed out: getAdapterConnectionState()", e);
                }
